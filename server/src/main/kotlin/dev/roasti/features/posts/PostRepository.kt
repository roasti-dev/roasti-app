...
class PostRepositoryImpl : PostRepository {
  ...
  override suspend fun findById(id: PostId): PostRow? =
  ...
  override suspend fun create(authorId: UserId, input: PostInput): PostRow =
      withContext(Dispatchers.IO) {
        val id = Uuid.random()
  ...
  override suspend fun update(id: PostId, input: PostInput): PostRow? =
      withContext(Dispatchers.IO) {
        transaction {
  ...
  override suspend fun delete(id: PostId): Unit =
      withContext(Dispatchers.IO) {
        transaction { PostTable.deleteWhere { PostTable.id eq id.value } }
      }
}
